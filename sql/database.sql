...
CREATE TABLE IF NOT EXISTS `tokens` (`user_id` varchar(255) NOT NULL,  `token` varchar(255) NOT NULL COMMENT 'refresh token',  `token_id` int(10) NOT NULL,  `token_created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP);
